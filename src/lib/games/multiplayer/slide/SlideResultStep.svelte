...
<div class="mt-7 text-center">
  ...
  <p class="mb-2 text-lg">Transform number into slide stop point</p>
  ...
  <ContentBlock className="p-6 text-left font-mono text-sm">
    ...
    <div class="mb-6 border-b border-gray-300 pb-4 dark:border-gray-600">
      ...
      <p class="leading-relaxed">
        houseEdge = <span class="font-bold text-blue-600 dark:text-blue-400">0.02</span>
      </p>
    </div>
    ...
    <div class="mb-4">
      ...
      <p class="leading-relaxed">slideStopPoint</p>
      <p class="leading-relaxed">
      ...
      <p class="leading-relaxed">
        ...
        >
        + 1) * (1 - <HighlightText>0.02</HighlightText>)) * 100) / 100
      </p>
      <p class="leading-relaxed font-bold">
        = <span class="text-green-600 dark:text-green-400">{slideStopPoint.toFixed(2)}x</span>
      </p>
    </div>
  </ContentBlock>
</div>
